...
//    }
   ...
   var sql="SELECT * FROM `users` WHERE id ='"+userId+"'";
   db.query(sql, function(err, results){
      res.render('editprofile.ejs',{data:results});
   });
};

exports.save_editprofile = function(req,res){
    ...
    var id = req.params.id;
        ...
        var query = db.query("UPDATE `users` set ? WHERE id = ? ",[data,id], function(err, rows)
        {
